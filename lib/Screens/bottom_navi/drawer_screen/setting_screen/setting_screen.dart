          ...
          children: [
            ...
            Row(
              children: [
                RoundBackButton(),
                SizedBox(width: 15),
                Text("My App Settings",style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold)),
              ],
            ),
            SizedBox(height: 20),
            ...
            Expanded(
                ...
                ListView(children: [
                  ...
                  settingRowHome(icon: "assets/notifi.svg",title: "Notifications",onTap: (){Get.to(()=>NotificationScreen());}),
                  SizedBox(height: 20),
                  settingRowHome(icon: "assets/recom.svg",title: "Recommend a friend",onTap: (){}),
                  SizedBox(height: 20),

                  settingRowHome(icon: "assets/privacy.svg",title: "Privacy Policy",onTap: (){Get.to(()=>PrivacyScreen());}),
                  SizedBox(height: 20),
                  settingRowHome(icon: "assets/term.svg",title: "Terms of Use",onTap: (){Get.to(()=>TermsUseScreen());}),

                  SizedBox(height: authUser['accType'] == 'Service Provider'?20:0),

                  authUser['accType'] == 'Service Provider'?
                  settingRowHome(icon: "assets/about.svg",title: "About Twiddle",onTap: (){Get.to(()=>TwiddleInv());})
                  : Container(),

                  SizedBox(height: authUser['accType'] == 'Service Provider'?20:0),

                  authUser['accType'] == 'Service Provider'?
                  settingRowHome(icon: "assets/faq.svg",title: "FAQs",onTap: (){Get.to(()=>FaqScreen());})
                      : Container(),

                  SizedBox(height: authUser['accType'] == 'Service Provider'?20:0),

                  authUser['accType'] == 'Service Provider'?
                  settingRowHome(icon: "assets/submit.svg",iconColor: maincolor,height: 25,title: "Submit Your Question",onTap: (){Get.to(()=>SubmitYourQuestion());})
                      : Container(),


                  SizedBox(height: 20),
                  settingRowHome(icon: "assets/helpsetting.svg",title: "Help",onTap: (){Get.to(()=>HelpDesk());}),
                  SizedBox(height: 20),
                  Container(
...
Widget settingRowHome({String? icon, Color? iconColor, double? height, String? title,required VoidCallback onTap}){
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: <Widget> [
            ...
            Row(
              children: <Widget> [
                SvgPicture.asset(icon!, height: height== null? 30 : height, color: iconColor,),
                SizedBox(width: 10),
