...
class TopUpTwiddleWallet extends StatefulWidget {
  const TopUpTwiddleWallet({Key? key}) : super(key: key);

  @override
  State<TopUpTwiddleWallet> createState() => _TopUpTwiddleWalletState();
}

class _TopUpTwiddleWalletState extends State<TopUpTwiddleWallet> {
          ...
          children: [
            ...
            Row(
              children: [
                RoundBackButton(),
                SizedBox(width: 10),
                Text("TOP-UP TWIDDLE WALLET",style: GoogleFonts.poppins(
                    color: Colors.black,
                    fontSize: 14.sp,
