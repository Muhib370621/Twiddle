      ...
      body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text("      My Total Tenants",style: TextStyle(color: Colors.black,fontSize: 20)),
              SizedBox(height: 40),
              Contacts(),
              SizedBox(height: 20),
              Contacts()
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xff8700FF),Color(0xffE600FF)]
        ),
        borderRadius: BorderRadius.circular(20)
      ),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 10),
            Text("Megan Men.",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold)),
            Spacer(),
            Container(
              width: Get.width*0.3,
              ...
              child: Center(child: Text("Contact",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.bold))),
            )
