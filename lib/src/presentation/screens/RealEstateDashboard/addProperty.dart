                      ...
                      children: [
                        ...
                        Row(children: [
                          Button(
                            ...
                            radius: 5,
                            text: "Yes",
                            buttonColor: tap == true ? AppColors.darkblue : AppColors.mainColor,
                            onTap: () {
                              setState(() {
                                tap = true;
                              });
                          ...
                          Button(
                            ...
                            radius: 5,
                            text: "No",
                            buttonColor: tap == false ? AppColors.kLightGrey : AppColors.kGreenAccent,
                            color: AppColors.welcomeTwiddle,
                            onTap: () {
                              setState(() {
                                tap = false;
                        ...
                        Row(children: [
                          Button(
                            ...
                            radius: 5,
                            text: "Yes",
                            buttonColor: ac == true ? AppColors.darkblue : AppColors.mainColor,
                            onTap: () {
                              setState(() {
                                ac = true;
                              });
                          ...
                          Button(
                            ...
                            radius: 5,
                            text: "No",
                            buttonColor: ac == false ? AppColors.kLightGrey : AppColors.kGreenAccent,
                            color: AppColors.welcomeTwiddle,
                            onTap: () {
                              setState(() {
                                ac = false;
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    color: AppColors.kWhite,),),
                                SizedBox(height: 15),
                                const Text("Price", style: TextStyle(color: AppColors.kWhite),),
                                SizedBox(height: 15),
                                MyTextField(
                                  onEditingComplete: () {
                                    setState(() {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10.h),
              const Text("Upload Cover Image", style: TextStyle(fontSize: 14),),
              SizedBox(height: 5.h),
              Text(
              ...
              SizedBox(height: 10.h,),
              Text('Upload Upto 6 Photos', style: TextStyle(fontSize: 14.sp),),
              SizedBox(height: 2.h,),
              Text('Type: jpg and png.', style: TextStyle(fontSize: 10.sp),),
              SizedBox(height: 2.h,),
              Row(
                          ...
                          Row(
                            children: [
                              MyContainer(
                                ...
                                child:
                                const Icon(
                                    Icons.add_a_photo_outlined, size: 30),
                              ),
                              SizedBox(width: 10.w),
                            ],
                          ))),
              ...
              Text('Maximum size 2mb.',
                style: TextStyle(color: AppColors.redText, fontSize: 10.sp),),
              SizedBox(height: 7.h),
              Text('Upload Upto One 360 View Image',
              ...
              Text('Maximum size 2mb.',
                style: TextStyle(color: AppColors.redText, fontSize: 10.sp),),
              SizedBox(height: 10.h),
              Text('Upload Upto One Video', style: TextStyle(fontSize: 14.sp),),
              SizedBox(height: 7.h),
                  ...
                  onTap: () {
                    if (houseNo.text.isNotEmpty &&
                      ...
                      if (value1 == true && value2 == true) {
                        if (widget.property == 'Update') {} else {
                          // addProperty(
                          //     '${widget.title}',
                          //     widget.desc,
                          //     widget.bedroom,
