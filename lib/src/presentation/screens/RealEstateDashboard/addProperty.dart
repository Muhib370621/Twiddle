...
// This funcion will helps you to pick a Video File
  pickVideo() async {
    ...
    if(pickedFile!=null){
      ...
      imagePath = await VideoThumbnail.thumbnailFile(video: pickedFile.path,maxHeight: 10,maxWidth: 30);
      setState(() {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Maximum size 2mb.',
                    style: TextStyle(color: AppColors.redText, fontSize: 13.sp),
                  ),
                  SizedBox(
                    height: 3.h,
                  ),
                  ...
                  MyContainer(
                    ...
                    child: Center(
                        child: MyContainer(
                            width: 40.w,
                            height: 40.h,
                            child: Image.asset(AppAssets.threeSixtyIcon))),
                  ),
                  SizedBox(height: 2.h),
                  Text(
                    'Maximum size 2mb.',
